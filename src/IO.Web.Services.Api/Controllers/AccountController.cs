using IO.Domain.Core.Notifications;
using IO.Domain.Interfaces;
using IO.Infra.CrossCutting.Identity.Authorization;
using IO.Infra.CrossCutting.Identity.Models;
using IO.Infra.CrossCutting.Identity.Models.AccountViewModels;
using MediatR;
...
namespace IO.Web.Services.Api.Controllers
{
    public class AccountController : BaseController
    {
        ...
        private async Task<object> GerarTokenUsuario(LoginViewModel login)
        {
            ...
            var response = new
            {
                ...
                {
                    id = user.Id,
                    nome = user.UserName, //orgUser.Nome,
                    email = user.Email, //orgUser.Email,
